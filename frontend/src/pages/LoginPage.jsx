          ...
          <div className="glass rounded-3xl p-8 border border-white/8">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-[14px] text-soft leading-relaxed max-w-xs mx-auto">
                Sign in to unlock unlimited stock analysis, real-time API data, and your personal history.
              </p>
            </div>
            ...
            <div className="space-y-2.5 mb-8">
              {[
                ['Unlimited stock queries', 'emerald'],
                ['Live NSE data via 5 AI/ML layers', 'emerald'],
                ['Your personal analysis history', 'emerald'],
                ['Monte Carlo + FinBERT sentiment', 'emerald'],
              ].map(([text, color]) => (
